...
\rput[B](5.5,4){\LARGE Feasible baskets}
...
\psline[linewidth=0.05cm,linecolor=violet]{<->}(0.5,-0.3)(10.5,-0.3)
\rput[B](5.5,-0.6){\LARGE \color{violet} $\omega_1$}
\psline[linewidth=0.05cm,linecolor=violet]{<->}(-0.2,0.5)(-0.2,7)
\rput[B](-0.6,4){\LARGE \color{violet} $\omega_2$}
