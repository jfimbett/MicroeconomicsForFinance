...
From $0 = \mathbb{E}[m(R_j - R_f)]$:
$$
\mathbb{E}[R_j] - R_f = -\frac{\mathrm{Cov}(m,R_j)}{\mathbb{E}[m]}\, R_f.
$$
 

- Assets that pay more in “bad” states (high $m$) have positive $\mathrm{Cov}(m,R_j)$ and lower expected returns.
- Conversely, assets that pay in “good” states (low $m$) require a premium.

---

## Numeric Example: CRRA, Two States

- Utility: $u(c) = \frac{c^{1-\gamma}}{1-\gamma}$, with $\gamma = 2$, $\beta = 0.96$.
- Probabilities: $\pi = (0.6, 0.4)$.
- Consumption: $c_0 = 1$, $c_1 = (1.10, 0.90)$.
- SDF: $m_s = \beta (c_1(s)/c_0)^{-\gamma}$ ⇒ $m = (0.96\cdot 1.10^{-2},\; 0.96\cdot 0.90^{-2}) \approx (0.793,\; 1.185)$.
- Risk-free: $\mathbb{E}[m] = 0.6\cdot 0.793 + 0.4\cdot 1.185 = 0.949$ ⇒ $R_f \approx 1/0.949 = 1.054$.
- Price an asset with state payoffs $a = (0,2)$:
  $$ q = \mathbb{E}[m\, a] = 0.6\cdot 0.793 \cdot 0 + 0.4\cdot 1.185 \cdot 2 = 0.948. $$
  Its expected return: $\mathbb{E}[R] = \mathbb{E}[a]/q = (0.6\cdot 0 + 0.4\cdot 2)/0.948 \approx 0.843 < R_f$ (pays in bad state ⇒ insurance ⇒ lower return).
...
- From assets 1 and 2: $0.9 = \psi_1$, $0.4 = \psi_1 \Rightarrow \psi_1=0.4$, $\psi_2=0.5$. Then asset 3 would imply $q_3 = 2\psi_2 = 1.0 \neq 0.9$ ⇒ NA violated.
...
$$\mathbb{E}_Q[\tilde a^{(1)}] = 0.783\cdot1 + 0.217\cdot0 = 0.783,\qquad q_1 = \frac{1}{R_f}\,\mathbb{E}_Q[\tilde a^{(1)}] = 1.15\cdot0.783 = 0.9.$$ 

Similarly for asset 2 with payoff $(1,2)$ we get $q_2 = 1.15\cdot(0.783+2\cdot0.217) = 1.4$.
