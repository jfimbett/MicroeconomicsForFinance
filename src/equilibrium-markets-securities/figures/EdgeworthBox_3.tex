...
\psplot[algebraic,linecolor=violet,linestyle=dotted,linewidth=0.05cm]{3.5}{7.833}{12.25 - 1.5*x}
\psplot[algebraic,linecolor=violet,linestyle=dotted,linewidth=0.05cm]{5}{9.333}{14.5 - 1.5*x}




\psline[linewidth=0.05cm,linecolor=violet,linestyle=dashed]{->}(5,4)(9,4)
\rput[B](9,4.2){\Large \red  $\nearrow$ in $A$'s budget }
\rput[B](9,3.5){\Large \blue  $\searrow$ in $B$'s budget }
