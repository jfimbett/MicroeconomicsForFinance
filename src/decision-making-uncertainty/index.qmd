...
$$
CE: \frac{CE^{-1}}{-1} = -0.0095 \Rightarrow CE^{-1} = 0.0095 \Rightarrow CE = 105.26
$$
...
**Question:**  
Approximate the optimal risky share $w^*$ using the mean–variance approximation.
...
$$
w^* \approx \frac{\mathbb{E}[\tilde{r}] - r_f}{R_R(y_0)\sigma^2}
$$

For $u(y)=\ln(y)$, $R_R(y)=1$. Thus,

$$
w^* = \frac{0.10 - 0.05}{(0.20)^2} = \frac{0.05}{0.04} = 1.25
$$

→ The investor invests **125%** of wealth in the risky asset (i.e. leveraged position).
